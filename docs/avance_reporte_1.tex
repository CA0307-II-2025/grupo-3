...
\makeatother
\subtitle{Avance Proyecto Final

CA-0307 Estadística Actuarial II}
\author{Diego Alberto Vega Víquez \and Gabriel Sanabria A. \and Jeikel Navarro \and Andy Roberto Peralta Duarte
Fonseca}
\date{}
...
\maketitle
\begin{abstract}
Aquí va a ir el resumen o abstract del proyecto \newpage
\end{abstract}
...
\section{Definición de la pregunta de investigación}

\textbf{Pregunta de investigación:}

¿Cuáles son las diferencias en la estructura de dependencia entre variables relacionadas con préstamos estudiantiles, al comparar universidades públicas y privadas?
...
Comparación de la estructura de dependencia entre variables de préstamos estudiantiles en universidades públicas y privadas mediante cópulas.
